...
class Network(BaseNetwork):
    def __init__(self, swin_unet_v2_emb, beta_schedule, module_name='swin_unet_v2', **kwargs):
        super(Network, self).__init__(**kwargs)
        if module_name == 'sr3':
            from .sr3_modules.unet import UNet
        elif module_name == 'guided_diffusion':
            from .guided_diffusion_modules.unet import UNet
        elif module_name == 'swin_unet_v2_emb':
            from .swin_unet_v2.swin_unet_v2_embsmall import SwinTransformerSys

        #self.denoise_fn = UNet(**unet)
        self.denoise_fn = SwinTransformerSys(**swin_unet_v2_emb)
    ...
    def forward(self, y_0, y_cond=None, mask=None, noise=None,ssim=ssim):
        ...
        # 使用新的权重组合loss
        print('0.0001*loss_G_Ang', 0.0001*loss_G_Ang)
        print('0.99899*loss',0.99899*loss)
        print('0.001*loss_gradient_SR',0.001*loss_gradient_SR)
        combined_loss = loss
        #combined_loss = 0.00001*loss_G_Ang + 0.99899*loss + 0.001*loss_gradient_SR
