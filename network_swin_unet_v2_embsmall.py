...
class Network(BaseNetwork):
    def __init__(self, swin_unet_v2_embsmall, beta_schedule, module_name='swin_unet_v2_embsmall', **kwargs):
        super(Network, self).__init__(**kwargs)
        if module_name == 'sr3':
            from .sr3_modules.unet import UNet
        elif module_name == 'guided_diffusion':
            from .guided_diffusion_modules.unet import UNet
        elif module_name == 'swin_unet_v2_embsmall':
            from .swin_unet_v2.swin_unet_v2_embsmall import SwinTransformerSys

        #self.denoise_fn = UNet(**unet)
        self.denoise_fn = SwinTransformerSys(**swin_unet_v2_embsmall)
    ...
    def p_mean_variance(self, y_t, t, clip_denoised: bool, y_cond=None):
        ...
        #print("noise_level is:", noise_level.cpu().numpy())
