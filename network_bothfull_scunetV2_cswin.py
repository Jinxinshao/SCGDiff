...
class Network(BaseNetwork):#SCUnet_V2
    def __init__(self, unet, beta_schedule, module_name='scunet_cswin_convnext', **kwargs):
        super(Network, self).__init__(**kwargs)
        if module_name == 'sr3':
            from .sr3_modules.unet import UNet
        elif module_name == 'guided_diffusion':
            from .guided_diffusion_modules.unet import UNet
        elif module_name == 'scunet_cswin_convnext':
            from .scunet.scunet_cswin_convnext import SCUNet
    ...
    def forward(self, y_0, y_cond=None, mask=None, noise=None,ssim =ssim):
        ...
        if mask is not None:
            ...
            loss = 4*loss_G_Ang + 6*loss #+ 5*loss_gradient_SR
        ...
        print('4*loss_G_Ang',4*loss_G_Ang)
        print('6*loss',6*loss)
