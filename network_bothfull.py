...
class Network(BaseNetwork):
    def __init__(self, swin_unet_v2, beta_schedule, module_name='swin_unet_v2', **kwargs):
        super(Network, self).__init__(**kwargs)
        if module_name == 'sr3':
            from .sr3_modules.unet import UNet
        elif module_name == 'guided_diffusion':
            from .guided_diffusion_modules.unet import UNet
        elif module_name == 'swin_unet_v2':
            from .swin_unet_v2.swin_unet_v2_embsmall import SwinTransformerSys

        #self.denoise_fn = UNet(**unet)
        self.denoise_fn = SwinTransformerSys(**swin_unet_v2)
    ...
    def forward(self, y_0, y_cond=None, mask=None, noise=None):
        ...
        if mask is not None:
            ...
            loss = loss_L_lab+ loss_L_lch + loss + 2*loss_gradient_SR
