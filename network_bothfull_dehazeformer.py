...
class Network(BaseNetwork):
    def __init__(self, unet, beta_schedule, module_name='dehazeformer', **kwargs):
        ...
        self.denoise_fn = dehazeformer_s(**unet)
    ...
    def forward(self, y_0, y_cond=None, mask=None, noise=None,ssim =ssim):
        ...
        print('0.999*loss',0.999*loss)
        combined_loss = 0.001*loss_G_Ang + 0.999*loss
