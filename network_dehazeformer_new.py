...
class Network(BaseNetwork):
    def __init__(self, dehazeformer, beta_schedule, module_name='dehazeformer', **kwargs):
        super(Network, self).__init__(**kwargs)
        if module_name == 'sr3':
            from .sr3_modules.unet import UNet
        elif module_name == 'guided_diffusion':
            from .guided_diffusion_modules.unet import UNet
        elif module_name == 'dehazeformer':
            from .dehazeformer.dehazeformer_embnew_sk import dehazeformer_s

        #self.denoise_fn = UNet(**unet)
        self.denoise_fn = dehazeformer_s(**dehazeformer)
